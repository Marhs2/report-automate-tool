...
<template>
  <textarea v-model="input" placeholder="보고서 내용을 입력하세요" rows="50" cols="30"></textarea>

  <button @click="sendReport" :disabled="aiLoading" style="margin-top: 10px; padding: 10px 20px; font-size: 16px;">
    {{ aiLoading ? "전송 중..." : "보내기" }}
  </button>
</template>
